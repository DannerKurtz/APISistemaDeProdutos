...
export const customerRouter = (router: Router) => {
  router.post('/api/customer', customerController.create); // POST route responsible for creating customers
  router.get('/api/customer', customerController.get); // GET route responsible for fetching customers
